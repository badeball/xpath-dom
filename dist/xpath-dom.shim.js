(function () {
  ...
  var evaluate$Y = evaluator.evaluate.bind(evaluator);
  var createExpression = evaluator.createExpression.bind(evaluator);
  var createNSResolver = evaluator.createNSResolver.bind(evaluator);

  if (!window.document.evaluate) {
    window.document.evaluate = evaluate$Y;
